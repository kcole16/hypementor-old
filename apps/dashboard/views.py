...
def dashboard(request):
	...
	if request.POST:
		...
		form = IndustryForm()
	return render_to_response('dashboard/dashboard.html',{'form':form, 'mentors':mentors}, 
...
def message(request):
	...
	if request.POST:
		...
		mentor = eval(query)
		form = MessageForm()
	return render_to_response('dashboard/message.html',{'form':form, 'mentor':mentor, 
			'mentor_id':mentor_id, 'submitted':submitted}, context_instance=RequestContext(request))
...
def mentor_profile(request, linkedin_id):
	...
	mentor = eval(query)
	return render_to_response('dashboard/mentor_profile.html', {'mentor':mentor, 
			'client_code':client_code}, context_instance=RequestContext(request))
